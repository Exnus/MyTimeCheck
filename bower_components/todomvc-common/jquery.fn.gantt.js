        ...
        var core = {
            ...
            createProgressBar: function (days, cls, desc, label, dataObj) {
                ...
                bar.click(function (e) {
                    ...
                    settings.onItemClick($(this).attr('class'));
                });
                return bar;
            },
            ...
            markNow: function (element) {
                switch (settings.scale) {
                    case "weeks":
                        ...
                        $(element).find(':findweek("' + cd + '")').removeClass('wd').addClass('today').append('<section class="line"></section><section class="wall"></section>');
                        break;
                    case "months":
                        $(element).find(':findmonth("' + new Date().getTime() + '")').removeClass('wd').addClass('today').append('<section class="line"></section><section class="wall"></section>');
                        break;
                    default:
                        var cd = Date.parse(new Date());
                        cd = (Math.floor(cd / 36400000) * 36400000);
                        $(element).find(':findday("' + cd + '")').removeClass('wd').addClass('today').append('<section class="line"></section><section class="wall"></section>');
                        break;
                }
            },
